function [PER,Factor,sub_infos] = OLSTEC_M(A_in,Omega_in,Rank,options,OPTS);
...
% Edited: Le Trung Thanh: Dec. 2020
...
if nargin < 5  flag = 0; % without performance estimation part
    Factors = [];
    PER     = [];
    ...
    PER.A  = zeros(1,tensor_dims(3));
    PER.B  = zeros(1,tensor_dims(3));
    PER.X  = zeros(1,tensor_dims(3));
end
