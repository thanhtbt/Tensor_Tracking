function [X_re] = OLSTEC_MOD(A_in, Omega, R, OPTS, options)
% OLSTEC algorith: 
%       H.Kasai, "Fast online low-rank tensor subspace tracking by CP decomposition using recursive least squares from incomplete observations"
%       Neurocomputing, 2019.
